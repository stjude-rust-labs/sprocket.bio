...
Sprocket will error. See the section on [overriding task CPU and memory requirements](/concepts/configuration#overriding-task-cpu-and-memory-requirements).
...
# after the task has completed when this setting is set to `false`.
