---
description: "Configure Sprocket's HPC backend to run WDL tasks on a Slurm cluster using Apptainer containers."
---
...
like the following example to your [`sprocket.toml`](/reference/backends/overview#backend-configuration)
...
An example conditional argument that applies a fictitious `sbatch` argument
