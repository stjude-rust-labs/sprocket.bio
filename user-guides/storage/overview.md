...
* [Azure Blob Storage](/user-guides/storage/azure.md)
* [AWS S3](/user-guides/storage/s3.md)
* [Google Cloud Storage](/user-guides/storage/gcs.md)
...
See the documentation for [Azure Blob Storage](/user-guides/storage/azure.md) for
...
* `s3` schemed URLs in the form `s3://<bucket>/<object>` (note: uses the
  [configured default region](/user-guides/storage/s3#default-region)).
...
See the documentation for [AWS S3](/user-guides/storage/s3.md) for information on
...
See the documentation for [Google Cloud Storage](/user-guides/storage/gcs.md) for
