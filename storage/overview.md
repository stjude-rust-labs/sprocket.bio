...
See the documentation for [Azure Blob Storage](/storage/azure.md) for
...
* `s3` schemed URLs in the form `s3://<bucket>/<object>` (note: uses the
  [configured default region](/storage/s3#default-region)).
...
See the documentation for [AWS S3](/storage/s3.md) for information on
...
See the documentation for [Google Cloud Storage](/storage/gcs.md) for
